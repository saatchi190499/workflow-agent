...
$runnerDestFull = [System.IO.Path]::GetFullPath($runnerDest)
if ([string]::Equals($runner, $runnerDestFull, [System.StringComparison]::OrdinalIgnoreCase)) {
    Write-Host "[1/6] Runner exe already in install dir, skipping copy..."
}
else {
